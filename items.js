...
const Kjellandsheia = [
    ...
    ['Kjellandsheia/DSC05637-2.jpg','','19/07-23'],
...
const vinter = [
    //['vinter/P3010465.jpg','','01/03-23'],
    //['vinter/P3010469.jpg','','01/03-23'],
    //['vinter/P3010471.jpg','','01/03-23'],
    //['vinter/P3010473.jpg','','01/03-23'],
    //['vinter/P3010476.jpg','','01/03-23'],
    //['vinter/P1220406.jpg','Kinto','22/01-23'],
    //['vinter/P1220418.jpg','Kinto','22/01-23'],
    //['vinter/P1220430.jpg','Kinto','22/01-23'],
    //['vinter/P1220457.jpg','Kinto','22/01-23'],
    //['vinter/PC300127.jpg','Nysnø','Nemo'],
    //['vinter/P3010518.jpg','','01/03-23'],
    //['vinter/P3020572.jpg','','02/03-23'],
    //['vinter/P3020665.jpg','','02/03-23'],
    //['vinter/P3020666.jpg','','02/03-23'],
    //['vinter/P2280212.jpg','','28/02-23'],
    //['vinter/P3010461.jpg','','01/03-23'],
    //['vinter/P1200446.jpg','Nabolaget','20/01-23'],
    //['vinter/P3010491.jpg','','01/03-23'],

    ['vinter/P2280116.jpg','Selfieruta','28/02-23'],
    //['vinter/P3010486.jpg','','01/03-23'],
    ['vinter/P5191352.jpg','Over Alpene',''],
    
    ['vinter/P4301204.jpg','Påske',''],
    ['vinter/P3010550.jpg','','01/03-23'],
    //['vinter/P2280370.jpg','','28/02-23'],
...
const sommer = [
    //['Portugal/P6010010.jpg','Miradouro de Santa Luzia','01/06-23'],
    //['sommer/P5292267.jpg','Hetebølge',''],
    //['Portugal/P6040416.jpg','Quinta de Regaleira','04/06-23, Sintra'],
    //['Portugal/P6040387.jpg','Quinta de Regaleira','04/06-23, Sintra'],
    //['Portugal/P6040389.jpg','Quinta de Regaleira','04/06-23, Sintra'],
    //['Portugal/P6040381.jpg','Quinta de Regaleira','04/06-23, Sintra'],
    //['Portugal/P6040408.jpg','Quinta de Regaleira','04/06-23, Sintra'],
    //['sommer/P8100016.jpg','',''],
    
    //['sommer/P5312406.jpg','Menn av Amalfi',''],
    //['sommer/P6012558.jpg','Vesuvio',''],
    
    //['sommer/P5312483.jpg','På vannet',''],
    //['Portugal/P6020037.jpg','Hibiskus','02/06-23, Jardim Botânico de Lisboa'],
    //['sommer/P8063697.jpg','Søgne',''],
...
const portretter = [
    ...
    //['Portugal/IMG_5851.jpg','Palace Fronteira','02/06-23'],
    //['Portugal/P6020307.jpg','Jardim Botânico de Lisboa','02/06-23'],
    //['Portugal/IMG_5849.jpg','Palace Fronteira','02/06-23'],
    //['Portugal/IMG_5850.jpg','Palace Fronteira','02/06-23'],
    //['Portugal/IMG_5851.jpg','Palace Fronteira','02/06-23'],
    //['Portugal/P6050972.jpg','Palace Fronteira','02/06-23'],
    //['Portugal/P6051097.jpg','Palace Fronteira','02/06-23'],
    //['Portugal/P6020117.jpg','Jardim Botânico de Lisboa','02/06-23'],
    //['Portugal/P6020224.jpg','Jardim Botânico de Lisboa','02/06-23'],   
    //['Portugal/P6020150.jpg','Jardim Botânico de Lisboa','02/06-23'],
    //['Portugal/P6020307.jpg','Jardim Botânico de Lisboa','02/06-23'],

    ['Portugal/IMG_5849.jpg','Palace Fronteira','02/06-23'], //Nora
...
// This block of code is creating an array of posts (posts) from the homepage 
// array. Each post is an object with an id, title, image, and potentially a 
// subtitle. The posts are created in reverse order from the homepage array, 
// wrapping back to the last item once all items have been processed.


// Set imageIndex to the last index of the homepage array. This indicates that we're starting from the last image
let imageIndex = homepage.length - 1;

// A for loop that runs as many times as the length of the homepage array. 
// The goal is to process each element of the homepage array.
for (let i = 1; i <= homepage.length; i++) {
    ...
    // Check if the element at the imageIndex of the homepage array is an array. 
    ...
    // Decrease the imageIndex by 1 to move to the previous element in the homepage array
    imageIndex--;
    
    // Check if the imageIndex is less than 0, which means we have processed all elements in the homepage array
    if (imageIndex < 0)
        // If all elements have been processed, reset imageIndex to the last index of the homepage array
        imageIndex = homepage.length - 1;
}
